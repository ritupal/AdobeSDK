...
#ifndef AEPUSERPROFILE_SWIFT_H
#define AEPUSERPROFILE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AEPUserProfile",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@interface AEPMobileUserProfile : NSObject <AEPExtension>
...
- (void)onRegistered;
- (void)onUnregistered;
- (BOOL)readyForEvent:(AEPEvent * _Nonnull)_ SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


@interface AEPMobileUserProfile (SWIFT_EXTENSION(AEPUserProfile))
...
/// \param attributeDict the dictionary containing attribute key-value pairs
///
...
/// \param attributeNames attribute keys/names which have to be removed.
///
...
///
/// \param completion the callback <code>closure</code> which will be called with user attributes
///
