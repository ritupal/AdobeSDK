...
#ifndef AEPASSURANCE_SWIFT_H
#define AEPASSURANCE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AEPAssurance",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS_NAMED("Assurance")
@interface AEPMobileAssurance : NSObject <AEPExtension>
...
@interface AEPMobileAssurance (SWIFT_EXTENSION(AEPAssurance))
...
///
+ (void)startSessionWithUrl:(NSURL * _Nullable)url;
@end
